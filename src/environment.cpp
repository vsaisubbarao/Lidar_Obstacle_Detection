...
//   renderPointCloud(viewer,inputCloud,"inputCloud");
  ...
  auto filterCloud = pointProcessorI->FilterCloud(inputCloud, 0.2 , Eigen::Vector4f (-10, -5, -3, 1), Eigen::Vector4f ( 25, 6.5, 3, 1));
  ...
  std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessorI->Clustering(segmentCloud.second, 0.1, 3, 40);
